...
public class Evaluation3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_evaluation3, container, false);
        ...
        companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Partner Update").addValueEventListener(new ValueEventListener() {
            @Override
