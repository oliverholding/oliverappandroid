...
public class WorkerPayrollProfilesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worker_payroll_profiles);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog dialog = new AlertDialog.Builder(WorkerPayrollProfilesActivity.this).create();

                LayoutInflater inflater = LayoutInflater.from(WorkerPayrollProfilesActivity.this);
                ...
                areaDialog = new SpinnerDialog(WorkerPayrollProfilesActivity.this,arr_area, "Selecciona la dependencia");
                ...
                denominationDialog = new SpinnerDialog(WorkerPayrollProfilesActivity.this,arr_denomination, "Selecciona la denominación");
                ...
                bossDialog = new SpinnerDialog(WorkerPayrollProfilesActivity.this,arr_boss, "Selecciona la dependencia jerárquica");
                ...
                responsable_areaDialog = new SpinnerDialog(WorkerPayrollProfilesActivity.this,arr_responsable_area, "Selecciona el Área responsable");
                ...
                missionDialog = new SpinnerDialog(WorkerPayrollProfilesActivity.this,arr_mission, "Selecciona la missión");
                ...
                btnRegister.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (TextUtils.isEmpty(edtName.getText().toString())) {
                            ...
                            Toasty.success(WorkerPayrollProfilesActivity.this, "Registrado", Toast.LENGTH_LONG).show();
                            dialog.dismiss();
                        }
                    }
                });
        ...
        FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder>
            ...
            protected void populateViewHolder(JobProfileViewHolder viewHolder, JobProfileModel model, int position) {
                ...
                viewHolder.btnViewJobProfile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(WorkerPayrollProfilesActivity.this, WorkersPayrollActivity.class);
