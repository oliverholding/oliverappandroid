...
import com.oalonedeveloper.oliver.oliverappandroidapp.CareManager.Logistic.Storage.WarehouseActivity;
...
public class InventoryControlActivity extends AppCompatActivity {
        ...
        FirebaseRecyclerAdapter<WarehousesModel, WarehousesViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<WarehousesModel, WarehousesViewHolder>
            ...
            protected void populateViewHolder(WarehousesViewHolder viewHolder, WarehousesModel model, int position) {
                ...
                viewHolder.btnManageWarehouse.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(InventoryControlActivity.this, WarehouseInventoryControlActivity.class);
    ...
    private void showRegisterWarehouseDialog() {
        final AlertDialog dialog = new AlertDialog.Builder(InventoryControlActivity.this).create();

        LayoutInflater inflater = LayoutInflater.from(InventoryControlActivity.this);
