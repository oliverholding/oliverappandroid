                ...
                toPath.setValue(dataSnapshot.getValue(), new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                        if (databaseError != null) {
                            ...
                            companyRef.child(post_key).child("My Bills").child(day+month+year+current_time).child("type").setValue("bill");
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edtDocumentNumber.getText().toString())) {
                    ...
                    txtDocumentNumber.setText("D.N.I: "+edtDocumentNumber.getText().toString().toUpperCase());
                    dialog.dismiss();
                }
            }
        });
