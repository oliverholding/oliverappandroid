...
public class DemmandNextYearProjectionFragment extends Fragment {
    ...
    TextView txtCurrentPeriod,txtProjectionNextYear;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_demmand_next_year_projection, container, false);
        ...
        txtProjectionNextYear = view.findViewById(R.id.txtProjectionNextYear);

        SimpleDateFormat month_date = new SimpleDateFormat("MMMM");
        String month_name = month_date.format(cal.getTime());

        txtCurrentPeriod.setText("PROYECCIÓN "+next_year+" "+month_name.toUpperCase());
        txtProjectionNextYear.setText("PROYECCIÓN "+next_year+"-"+month);
    ...
    private void showProducts() {
        ...
        FirebaseRecyclerAdapter<ProductsModel, CompanyProductsViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ProductsModel, CompanyProductsViewHolder>
                (ProductsModel.class,R.layout.proyection_quantity_next_year_item, CompanyProductsViewHolder.class,query) {
            @Override
            protected void populateViewHolder(final CompanyProductsViewHolder viewHolder, ProductsModel model, int position) {
                ...
                companyRef.child(post_key).child("My Products").child(postKey).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild(next_year + "" + month + "quantity_projection")) {
                            int last_year_month_quantity = dataSnapshot.child(next_year + "" + month + "quantity_projection").getValue(Integer.class);
                            viewHolder.txtPercent.setText(last_year_month_quantity+"");
                        ...
                        if (dataSnapshot.hasChild(year + "" + month + "quantity")) {
                            int last_year_month_quantity = dataSnapshot.child(year + "" + month + "quantity").getValue(Integer.class);
