...
public class SupplierEvluationQualityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_supplier_evluation_quality, container, false);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        companyRef.child(post_key).child("Purchased Items").child(product_id).child("Suppliers").child(postKey).child("Delivery on Time").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                double total_deliver = sum+sum1;
                                String total_st = decimalFormat.format(total_deliver);

                                viewHolder.txtCurrentPeriodPrice.setText(total_st);
