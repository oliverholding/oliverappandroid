...
public class JobProfileDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment1 = new JobProfileInformationFragment();
        fragment2 = new CoordinationsFragment();
        fragment3 = new FunctionsJobProfileFragment();
