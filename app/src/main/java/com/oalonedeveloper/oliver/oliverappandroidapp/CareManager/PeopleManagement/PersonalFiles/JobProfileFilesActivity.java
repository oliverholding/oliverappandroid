...
public class JobProfileFilesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_profile_files);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog dialog = new AlertDialog.Builder(JobProfileFilesActivity.this).create();

                LayoutInflater inflater = LayoutInflater.from(JobProfileFilesActivity.this);
                ...
                areaDialog = new SpinnerDialog(JobProfileFilesActivity.this,arr_area, "Selecciona la dependencia");
                ...
                denominationDialog = new SpinnerDialog(JobProfileFilesActivity.this,arr_denomination, "Selecciona la denominación");
                ...
                bossDialog = new SpinnerDialog(JobProfileFilesActivity.this,arr_boss, "Selecciona la dependencia jerárquica");
                ...
                responsable_areaDialog = new SpinnerDialog(JobProfileFilesActivity.this,arr_responsable_area, "Selecciona el Área responsable");
                ...
                missionDialog = new SpinnerDialog(JobProfileFilesActivity.this,arr_mission, "Selecciona la missión");
                ...
                btnRegister.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (TextUtils.isEmpty(edtName.getText().toString())) {
                            ...
                            Toasty.success(JobProfileFilesActivity.this, "Registrado", Toast.LENGTH_LONG).show();
                            dialog.dismiss();
                        }
                    }
                });
        ...
        FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder>
            ...
            protected void populateViewHolder(JobProfileViewHolder viewHolder, JobProfileModel model, int position) {
                ...
                viewHolder.btnViewJobProfile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(JobProfileFilesActivity.this, PersonalFilesActivity.class);
