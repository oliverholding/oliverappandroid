...
public class ProductionOrdersManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_production_orders_management);
        ...
        fragment1 = new ProductionOrderChainFragment();
        fragment2 = new ProductionOrdersInventoryFragment();
