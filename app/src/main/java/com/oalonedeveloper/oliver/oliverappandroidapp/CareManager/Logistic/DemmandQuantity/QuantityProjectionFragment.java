...
public class QuantityProjectionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_quantity_projection, container, false);
        ...
        txtLastPeriod.setText("PERÍODO "+last_year+" - UNIDADES");
