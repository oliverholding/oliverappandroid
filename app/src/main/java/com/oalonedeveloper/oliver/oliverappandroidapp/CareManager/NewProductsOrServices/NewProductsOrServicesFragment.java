package com.oalonedeveloper.oliver.oliverappandroidapp.CareManager.NewProductsOrServices;
...
import com.oalonedeveloper.oliver.oliverappandroidapp.CareManager.BusinessModelModule.BusinessModelToolsActivity;
import com.oalonedeveloper.oliver.oliverappandroidapp.R;


public class NewProductsOrServicesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_new_products_or_services, container, false);
        ...
        btnTest1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), NewProductsOrServicesToolsActivity.class);
