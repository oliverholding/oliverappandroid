...
public class FinancialInstitutionsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_financial_institutions, container, false);
            ...
            protected void populateViewHolder(FinancialInstitutionsViewHolder viewHolder, FinancialInstitutionModel model, int position) {
                ...
                viewHolder.btnVisit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getActivity(),FinancialInstitutionDetailActivity.class);
