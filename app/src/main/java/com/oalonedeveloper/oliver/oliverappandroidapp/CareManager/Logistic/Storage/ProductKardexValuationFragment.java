...
public class ProductKardexValuationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_product_kardex_valuation, container, false);
    ...
    private void showKardex() {
        ...
        FirebaseRecyclerAdapter<KardexModel, KardexItemsViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<KardexModel, KardexItemsViewHolder>
                (KardexModel.class,R.layout.kardex_valuation_item,KardexItemsViewHolder.class,query) {
            @Override
    ...
    public static class KardexItemsViewHolder extends RecyclerView.ViewHolder {
        View mView;
        TextView txtKardexDate,txtKardexConcept,txtValuation;
        ...
        public KardexItemsViewHolder(@NonNull View itemView) {
            ...
            txtValuation = mView.findViewById(R.id.txtValuation);
