...
public class JobProfilesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_profiles);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog dialog = new AlertDialog.Builder(JobProfilesActivity.this).create();

                LayoutInflater inflater = LayoutInflater.from(JobProfilesActivity.this);
                ...
                areaDialog = new SpinnerDialog(JobProfilesActivity.this,arr_area, "Selecciona la dependencia");
                ...
                denominationDialog = new SpinnerDialog(JobProfilesActivity.this,arr_denomination, "Selecciona la denominación");
                ...
                bossDialog = new SpinnerDialog(JobProfilesActivity.this,arr_boss, "Selecciona la dependencia jerárquica");
                ...
                responsable_areaDialog = new SpinnerDialog(JobProfilesActivity.this,arr_responsable_area, "Selecciona el Área responsable");
                ...
                missionDialog = new SpinnerDialog(JobProfilesActivity.this,arr_mission, "Selecciona la missión");
                ...
                btnRegister.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (TextUtils.isEmpty(edtName.getText().toString())) {
                            ...
                            Toasty.success(JobProfilesActivity.this, "Registrado", Toast.LENGTH_LONG).show();
                            dialog.dismiss();
                        }
                    }
                });
        ...
        FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder>
            ...
            protected void populateViewHolder(JobProfileViewHolder viewHolder, JobProfileModel model, int position) {
                ...
                viewHolder.btnViewJobProfile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(JobProfilesActivity.this, JobProfileDetailActivity.class);
