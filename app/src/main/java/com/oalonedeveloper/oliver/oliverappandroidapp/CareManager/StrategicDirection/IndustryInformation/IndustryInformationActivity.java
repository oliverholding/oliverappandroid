...
public class IndustryInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment1 = new EnviromentIndustryInformationFragment();
        fragment2 = new IndustryProfileFragment();
        fragment3 = new SumaryIndustryProfileFragment();
