...
import com.oalonedeveloper.oliver.oliverappandroidapp.CareManager.IntructionModule.IntroductionModuleFragment;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 2:
                    return new PeriodicalTest1Fragment();
                case 3:
                    return new PeriodicalTest2Fragment();
                case 4:
                    return new PeriodicalTest3Fragment();
                case 5:
                    return new PeriodicalTest4Fragment();
                case 6:
                    return new PeriodicalTest5Fragment();
                case 7:
                    return new PeriodicalTest6Fragment();
                case 8:
