...
public class CirticalInventoryControlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cirtical_inventory_control);
    ...
    private void showWareHouses() {
        ...
        FirebaseRecyclerAdapter<WarehousesModel, WarehousesViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<WarehousesModel, WarehousesViewHolder>
            ...
            protected void populateViewHolder(WarehousesViewHolder viewHolder, WarehousesModel model, int position) {
                ...
                viewHolder.btnManageWarehouse.setText("SELECCIONAR");

                viewHolder.btnManageWarehouse.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(CirticalInventoryControlActivity.this, WareHouseCriticalInventoryControlActivity.class);
    ...
    private void showRegisterWarehouseDialog() {
        final AlertDialog dialog = new AlertDialog.Builder(CirticalInventoryControlActivity.this).create();

        LayoutInflater inflater = LayoutInflater.from(CirticalInventoryControlActivity.this);
