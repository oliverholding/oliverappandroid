...
public class WarehouseInventoryControlStockFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_warehouse_inventory_control_stock, container, false);
    ...
    private void showWarehouseProducts() {
        ...
        FirebaseRecyclerAdapter<ProductsModel, CompanyProductsViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ProductsModel, CompanyProductsViewHolder>
                (ProductsModel.class,R.layout.product_inventory_control_quantity_item,CompanyProductsViewHolder.class,query) {
            @Override
            protected void populateViewHolder(final CompanyProductsViewHolder viewHolder, ProductsModel model, int position) {
                ...
                viewHolder.txtProductName.setText(viewHolder.my_product_stock);
                viewHolder.txtWarehouseStock.setText("S/ "+viewHolder.my_product_price);
                double stock = Double.parseDouble(viewHolder.my_product_stock);
                ...
                viewHolder.txtStoreStock.setText("S/ "+total_st);
