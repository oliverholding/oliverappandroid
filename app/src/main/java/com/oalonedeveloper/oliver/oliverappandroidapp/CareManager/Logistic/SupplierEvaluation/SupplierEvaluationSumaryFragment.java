...
public class SupplierEvaluationSumaryFragment extends Fragment {
    ...
    double sum,sum1,total_deliver,deliver_delay,deliver_on_time,deliver_returned,price_var_weight,time_var_weight,quality_var_weight,average_current_year,average_last_year;
