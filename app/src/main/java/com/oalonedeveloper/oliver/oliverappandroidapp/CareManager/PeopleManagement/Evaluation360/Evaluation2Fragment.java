...
public class Evaluation2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_evaluation2, container, false);
        ...
        companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader Update").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        btnFinish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rating1 == -1) {
                    ...
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_1").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_2").child("score").setValue(rating2);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_3").child("score").setValue(rating3);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_4").child("score").setValue(rating4);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_5").child("score").setValue(rating5);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_6").child("score").setValue(rating6);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_7").child("score").setValue(rating7);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_8").child("score").setValue(rating8);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_9").child("score").setValue(rating9);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_10").child("score").setValue(rating10);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_11").child("score").setValue(rating11);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_12").child("score").setValue(rating12);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_13").child("score").setValue(rating13);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_14").child("score").setValue(rating14);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_15").child("score").setValue(rating15);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_16").child("score").setValue(rating16);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_17").child("score").setValue(rating17);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_18").child("score").setValue(rating18);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_19").child("score").setValue(rating19);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_20").child("score").setValue(rating20);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader Update").child("date_last_update").setValue(saveCurrentDate);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader Update").child("time_last_update").setValue(saveCurrentTime);
