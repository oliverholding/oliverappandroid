        ...
        btnFinish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rating1 == -1) {
                    ...
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_2").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_3").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_4").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_5").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_6").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_7").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_8").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_9").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_10").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_11").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_12").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_13").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_14").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_15").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_16").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_17").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_18").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_19").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_20").child("score").setValue(rating1);
                    companyRef.child(post_key).child("Job Profile").child(profile_id).child("Evaluation").child("Leader").child("test_20").child("score").setValue(rating1);
