...
public class CompanyLoanRequestSentSuccessfullyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_loan_request_sent_successfully);
        ...
        financialInstitutionsRef.child(institution_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(CompanyLoanRequestSentSuccessfullyActivity.this).load(financial_institution_background_image).fit().into(imgBackground);
                ...
                financialInstitutionsRef.child(institution_key).child("Company Products").child(product_key).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Picasso.with(CompanyLoanRequestSentSuccessfullyActivity.this).load(product_img).fit().into(imgProductImage);
        ...
        btnRequests.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CompanyLoanRequestSentSuccessfullyActivity.this, CompanyLoanRequestsListActivity.class);
