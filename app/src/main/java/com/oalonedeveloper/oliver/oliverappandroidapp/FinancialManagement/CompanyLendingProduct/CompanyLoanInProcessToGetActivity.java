...
public class CompanyLoanInProcessToGetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_loan_in_process_to_get);
        ...
        financialInstitutionsRef.child(institution_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(CompanyLoanInProcessToGetActivity.this).load(financial_institution_background_image).fit().into(imgBackground);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        financialInstitutionsRef.child(institution_key).child("Company Products").child(issuing_product_id).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                Picasso.with(CompanyLoanInProcessToGetActivity.this).load(product_img).fit().into(imgProductImage);
        ...
        btnRequests.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CompanyLoanInProcessToGetActivity.this, CompanyLoanRequestsListActivity.class);
