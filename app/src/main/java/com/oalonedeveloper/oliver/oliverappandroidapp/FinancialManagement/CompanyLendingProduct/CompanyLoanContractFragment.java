...
import com.oalonedeveloper.oliver.oliverappandroidapp.FinancialManagement.LendingProduct.LoanBankAccountsFragment;
...
public class CompanyLoanContractFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_company_loan_contract, container, false);
        ...
        fragment3 = new CompanyLoanBankAccountsFragment();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                financialInstitutionsRef.child(post_key).child("Company Products").child(issuing_product_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        new CompanyLoanContractFragment.RetrivePdfStream().execute(product_file1);
