    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog dialog = new AlertDialog.Builder(JobProfileRoasterActivity.this).create();

                LayoutInflater inflater = LayoutInflater.from(JobProfileRoasterActivity.this);
                ...
                areaDialog = new SpinnerDialog(JobProfileRoasterActivity.this,arr_area, "Selecciona la dependencia");
                ...
                denominationDialog = new SpinnerDialog(JobProfileRoasterActivity.this,arr_denomination, "Selecciona la denominación");
                ...
                bossDialog = new SpinnerDialog(JobProfileRoasterActivity.this,arr_boss, "Selecciona la dependencia jerárquica");
                ...
                responsable_areaDialog = new SpinnerDialog(JobProfileRoasterActivity.this,arr_responsable_area, "Selecciona el Área responsable");
                ...
                missionDialog = new SpinnerDialog(JobProfileRoasterActivity.this,arr_mission, "Selecciona la missión");
                ...
                btnRegister.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (TextUtils.isEmpty(edtName.getText().toString())) {
                            ...
                            Toasty.success(JobProfileRoasterActivity.this, "Registrado", Toast.LENGTH_LONG).show();
                            dialog.dismiss();
                        }
                    }
                });
        ...
        FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder>
            ...
            protected void populateViewHolder(JobProfileViewHolder viewHolder, JobProfileModel model, int position) {
                ...
                viewHolder.btnViewJobProfile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(JobProfileRoasterActivity.this, RoasterAndPerfomanceActivity.class);
