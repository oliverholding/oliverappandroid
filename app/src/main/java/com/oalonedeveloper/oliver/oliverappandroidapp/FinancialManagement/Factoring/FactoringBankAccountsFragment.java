...
public class FactoringBankAccountsFragment extends Fragment {
    ...
    String cc,cci,currency,financial_institution;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_factoring_bank_accounts, container, false);
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox.isChecked()) {
                    lendingRef.child(operation_id).child("factoring_state").setValue("approved");
                    financialInstitutionsRef.child(post_key).child("Factoring Request").child(request_id).child("request_state").setValue("ready");
            ...
            protected void populateViewHolder(final LoanBankAccountViewHolder viewHolder, LoanBankAccountModel model, int position) {
                ...
                viewHolder.btnSelectBankAccount.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        cc = viewHolder.my_account_cc;
                        cci = viewHolder.my_account_cci;
                        currency = viewHolder.my_account_currency;
                        financial_institution = viewHolder.my_financial_institution_name;
                    }
                });
            }
        };
