...
public class JobProfilesEvaluationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_profiles_evaluations);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog dialog = new AlertDialog.Builder(JobProfilesEvaluationsActivity.this).create();

                LayoutInflater inflater = LayoutInflater.from(JobProfilesEvaluationsActivity.this);
                ...
                areaDialog = new SpinnerDialog(JobProfilesEvaluationsActivity.this,arr_area, "Selecciona la dependencia");
                ...
                denominationDialog = new SpinnerDialog(JobProfilesEvaluationsActivity.this,arr_denomination, "Selecciona la denominación");
                ...
                bossDialog = new SpinnerDialog(JobProfilesEvaluationsActivity.this,arr_boss, "Selecciona la dependencia jerárquica");
                ...
                responsable_areaDialog = new SpinnerDialog(JobProfilesEvaluationsActivity.this,arr_responsable_area, "Selecciona el Área responsable");
                ...
                missionDialog = new SpinnerDialog(JobProfilesEvaluationsActivity.this,arr_mission, "Selecciona la missión");
                ...
                btnRegister.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (TextUtils.isEmpty(edtName.getText().toString())) {
                            ...
                            Toasty.success(JobProfilesEvaluationsActivity.this, "Registrado", Toast.LENGTH_LONG).show();
                            dialog.dismiss();
                        }
                    }
                });
        ...
        FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<JobProfileModel, JobProfileViewHolder>
            ...
            protected void populateViewHolder(JobProfileViewHolder viewHolder, JobProfileModel model, int position) {
                ...
                viewHolder.btnViewJobProfile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(JobProfilesEvaluationsActivity.this, Evaluation360Activity.class);
